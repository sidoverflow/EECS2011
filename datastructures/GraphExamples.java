...
public class GraphExamples {
	...
	public static Graph<String, Integer> figure14_3() {
		String[][] edges = { { "BOS", "SFO" }, { "BOS", "JFK" },
				{ "BOS", "MIA" }, { "JFK", "BOS" }, { "JFK", "DFW" },
				{ "JFK", "MIA" }, { "JFK", "SFO" }, { "ORD", "DFW" },
				{ "ORD", "MIA" }, { "LAX", "ORD" }, { "DFW", "SFO" },
				{ "DFW", "ORD" }, { "DFW", "LAX" }, { "MIA", "DFW" },
				{ "MIA", "LAX" }, };
	...
	public static Graph<String, Integer> figure14_11() {
		String[][] edges = { { "BOS", "JFK" }, { "BOS", "MIA" },
				{ "JFK", "BOS" }, { "JFK", "DFW" }, { "JFK", "MIA" },
				{ "JFK", "SFO" }, { "ORD", "DFW" }, { "LAX", "ORD" },
				{ "DFW", "SFO" }, { "DFW", "ORD" }, { "DFW", "LAX" },
				{ "MIA", "DFW" }, { "MIA", "LAX" }, };
		return graphFromEdgelist(edges, true);
	}
	...
	public static Graph<String, Integer> figure14_15() {
		String[][] edges = { { "SFO", "LAX", "337" }, { "SFO", "BOS", "2704" },
				{ "SFO", "ORD", "1846" }, { "SFO", "DFW", "1464" },
				{ "LAX", "DFW", "1235" }, { "LAX", "MIA", "2342" },
				{ "DFW", "ORD", "802" }, { "DFW", "JFK", "1391" },
				{ "DFW", "MIA", "1121" }, { "ORD", "BOS", "867" },
				{ "ORD", "PVD", "849" }, { "ORD", "JFK", "740" },
				{ "ORD", "BWI", "621" }, { "MIA", "BWI", "946" },
				{ "MIA", "JFK", "1090" }, { "MIA", "BOS", "1258" },
				{ "BWI", "JFK", "184" }, { "JFK", "PVD", "144" },
				{ "JFK", "BOS", "187" }, };
		return graphFromEdgelist(edges, false);
	}
