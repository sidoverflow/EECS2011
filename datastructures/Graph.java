 ...
 * directed or undirected. In the case of an undirected graph, methods
 * outgoingEdges and incomingEdges return the same collection, and outDegree and
 * inDegree return the same value.
 *
...
public interface Graph<V, E> {
	...
	/**
	 * Returns the number of edges leaving vertex v. Note that for an undirected
	 * graph, this is the same result returned by inDegree
	 * 
