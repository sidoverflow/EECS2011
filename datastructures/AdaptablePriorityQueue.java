...
/**
 * Interface for the adaptable priority queue ADT. The Entry instance returned
 * by the insert method can later be used to remove the entry, or to modify that
 * entry's key or value.
 *
