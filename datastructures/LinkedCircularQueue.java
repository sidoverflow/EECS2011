...
public class LinkedCircularQueue<E> implements CircularQueue<E> {
	 ...
	 * a shorthand for enqueue(dequeue()), except that it does nothing if the
	...
	/**
	 * Produces a string representation of the contents of the queue. (from
	 * front to back). This exists for debugging purposes only.
	 */
	@Override
